    ...
    with torch.no_grad():
        for i, batch in enumerate(loader):
            ...
            if is_distributed:
                ...
                embeddings.append(embed[np.unique(bid, return_index=True)[
                    1]])
            else:
...
def save_candidates(mentions, candidates, entity_map, labels, out_dir, part):
    # TODO: save the retrieval results {doc_id, positives:[entity_titles],
    #  negatives: [entity_titles]}
