...
```
python preprocess_data.py --raw_dir /raw_aida/  --out_aida_dir /retriever_input/  --raw_kb_dir /raw_kb/ --out_kb_path /kb/entities_kilt.json  --max_ent_len 128  --instance_length 32 --stride 16 --pos_prop 1 --title_map_dir /raw_aida/
